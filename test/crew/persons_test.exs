defmodule Crew.PersonsTest do
  ...
  #   @valid_attrs %{action_key: "some action_key", action_quantity: 42, body: "some body", notification_type: "some notification_type", priority: 42, seen: true, sent: true, subject: "some subject", via_email: true, via_sms: true, via_web: true}
  #   @update_attrs %{action_key: "some updated action_key", action_quantity: 43, body: "some updated body", notification_type: "some updated notification_type", priority: 43, seen: false, sent: false, subject: "some updated subject", via_email: false, via_sms: false, via_web: false}
  #   @invalid_attrs %{action_key: nil, action_quantity: nil, body: nil, notification_type: nil, priority: nil, seen: nil, sent: nil, subject: nil, via_email: nil, via_sms: nil, via_web: nil}
  ...
  #   test "list_person_notifications/0 returns all person_notifications" do
  #     notification = notification_fixture()
  #     assert Persons.list_person_notifications() == [notification]
  #   end
  ...
  #     notification = notification_fixture()
  #     assert {:ok, %Notification{} = notification} = Persons.update_notification(notification, @update_attrs)
  ...
  #     notification = notification_fixture()
  #     assert {:error, %Ecto.Changeset{}} = Persons.update_notification(notification, @invalid_attrs)
