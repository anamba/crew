defmodule Crew.AccountsTest do
  use Crew.DataCase

  alias Crew.Accounts
  import Crew.AccountsFixtures
  alias Crew.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "validates email and password when given" do
      {:error, changeset} = Accounts.register_user(%{email: "not valid", password: "o8NjdqK"})
  ...
  describe "users" do
    ...
    @valid_attrs %{
      ...
      name: "some name",
      password: "o8NjdqKjrmfiU3E-bsPWJVvm"
    }
