defmodule CrewWeb.ActivityLiveTest do
  ...
  @create_attrs %{description: "some description", max_duration_minutes: 42, min_duration_minutes: 42, name: "some name", slug: "some slug"}
