defmodule CrewWeb.UserAuthTest do
  use CrewWeb.ConnCase

  alias Crew.Accounts
  alias CrewWeb.UserAuth
  import Crew.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CrewWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CrewWeb.Endpoint.subscribe(live_socket_id)
